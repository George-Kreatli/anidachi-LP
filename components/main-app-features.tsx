...
import { Users, MessageSquare, History, Smartphone, ArrowRight } from "lucide-react"
...
export function MainAppFeatures() {
  const features = [
    ...
    },
    {
      ...
      description:
        "Seamlessly switch between devices while maintaining your watch progress and staying connected with your watchroom members.",
      benefit: "Watch anywhere, anytime",
      color: "orange",
    },
  ]
    ...
    <section className="py-24 bg-gradient-to-b from-white to-gray-50">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <h2 className="text-3xl md:text-5xl font-bold text-gray-900 mb-6">Your Anime Social Hub</h2>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Transform solo viewing into shared experiences with powerful features designed for anime lovers
          </p>
        </div>
          ...
          {features.map((feature, index) => (
            ...
            >
              <CardHeader className="pb-4">
                <div
                  className={`w-14 h-14 rounded-xl flex items-center justify-center mb-4 transition-all duration-300 ${getColorClasses(feature.color)}`}
                >
                ...
                <div className="text-sm font-medium text-purple-600 mb-3">{feature.benefit}</div>
              </CardHeader>
              <CardContent>
